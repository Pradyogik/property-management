    ...
    <div className="fixed inset-0 bg-black/60 dark:bg-black/80 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-6xl max-h-[90vh] overflow-hidden">
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-4rem)]">
                  ...
                  {property.installments.map(
                    (installment: Installment, index: number) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 text-sm text-gray-900 dark:text-white">
                          {installment.delayed_interest_amount
                            ? `₹${installment.delayed_interest_amount}`
                            : "-"}
                        </td>
                        <td className="px-6 py-4 text-sm text-gray-900 dark:text-white">
          ...
          {/* service charge */}
          <div className="serviceChargeDiv">
            ...
            <div className="overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700">
              <table className="min-w-full">
                ...
                <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                  {property.service_charges.map(
                    (service_charge: ServiceCharge, index: number) => (
                      <tr
                        key={index}
                        className="hover:bg-gray-50 dark:hover:bg-gray-700"
                      >
                        ...
                        <td className="px-6 py-4 text-sm text-gray-900 dark:text-white">
                          {service_charge.service_charges_late_fee
                            ? `₹${service_charge.service_charges_late_fee}`
                            : "-"}
                        </td>
                        <td className="px-6 py-4 text-sm text-gray-900 dark:text-white">
