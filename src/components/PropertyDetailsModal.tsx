        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-4rem)]">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12">
              ...
              <DetailItem label="पिता/पति का नाम" value={property.father_name || '-'} />
              <DetailItem label="आवंटित संपत्ति की श्रेणी" value={property.category} />
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <DetailItem label="विक्रय मूल्य" value={`₹${property.salePrice || 0}`} />
              <DetailItem label="फ्री होल्ड धनराशि" value={`₹${property.freeholdAmount || 0}`} />
              <DetailItem label="लीज रेंट की धनराशि" value={`₹${property.leaseRentAmount || 0}`} />
              <DetailItem label="पार्क चार्ज" value={`₹${property.parkCharge || 0}`} />
              <DetailItem label="कार्नर चार्ज" value={`₹${property.cornerCharge || 0}`} />
              <DetailItem label="अवशेष विक्रय मूल्य एकमुश्त जमा धनराशि" value={`₹${property.remainingSalePrice || 0}`} />
            </div>
          </div>
                ...
                <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                  {paymentHistory.map((payment, index) => (
                    <tr key={index} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                      <td className="px-6 py-4 text-sm text-gray-900 dark:text-white">₹{payment.installmentAmount.toFixed(2)}</td>
                      <td className="px-6 py-4 text-sm text-gray-900 dark:text-white">₹{payment.interestAmount.toFixed(2)}</td>
                      <td className="px-6 py-4 text-sm text-gray-900 dark:text-white">{payment.delayedInterest ? `₹${payment.delayedInterest.toFixed(2)}` : '-'}</td>
...
//             <h3 className="text-lg font-semibold mb-4">Basic Information</h3>
//             <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12">
//               <DetailItem label="योजना का नाम" value={property.schemeName} />
//               <DetailItem label="Property Unique ID" value={property.uniqueId} />
//               <DetailItem label="आवंटी का नाम" value={property.allottee_name} />
...
//               <DetailItem label="आवंटित संपत्ति की संख्या" value={property.plotNumber} />
//               <DetailItem label="पंजीकरण धनराशि" value={`₹${property.registrationAmount}`} />
//               <DetailItem label="पंजीकरण दिनांक" value={property.registrationDate} />
//             </div>
//           </div>
...
//             <h3 className="text-lg font-semibold mb-4">Contact Information</h3>
//             <div className="grid grid-cols-1 gap-4">
//               <DetailItem label="आवंटी का स्थायी पता" value={property.permanentAddress} />
//               <DetailItem label="आवंटी का वर्तमान पता" value={property.currentAddress} />
//               <DetailItem label="मोबाइल नंबर" value={property.mobile} />
//             </div>
//           </div>
